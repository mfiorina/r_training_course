...
<div style="text-align: right"><font size = -1>For a PDF version of this document, please click [here](https://mfiorina.github.io/r_training_course/syllabus/r_course_syllabus.pdf).</font></div>
...
### The course slides, syllabus, and other resources are available at the following link: https://mfiorina.github.io/r_training_course/.
...
|:--------:|:-----------------:|:----------:|:---------:|
| Thursday | February 5, 2025  | 15:00 CET  | 17:00 CET |
| Thursday | February 12, 2025 | 15:00 CET  | 17:00 CET |
| Thursday | February 17, 2025 | 15:00 CET  | 17:00 CET |
</center>
...
- Download R at this link: https://cran.r-project.org/
  - Windows users, click on 'Download R for Windows' and then download the 'base' version. The file should be called `R-4.5.2-win.exe`.
  - Mac users, click on 'Download R for MacOS' and then download the file called:
      - `R-4.5.2-arm64.pkg` if you have a more recent MacBook with an M1,2... chip.
      - `R-4.5.2.pkg` if you have an older MacBook with an Intel chip.
...
- RStudio, [RStudio Cheatsheets](https://posit.co/resources/cheatsheets/). Cheatsheets to help perform basic data tasks in R.
...
- [The World Bank DIME Wiki](https://dimewiki.worldbank.org/). A wiki with open-source articles on how to be a research assistant with the World Bank. Great insights into collaborative data work, reproducibility, and the responsibilities of an entry-level data researcher.

<br>

### Session 1 — Introduction to R

- For those who are fully new to R, I strongly recommend: Thomas Mock, "A Gentle Introduction to Tidy Statistics in R" — [blog post](https://themockup.blog/posts/2018-12-10-a-gentle-guide-to-tidy-statistics-in-r/) and [video](https://posit.co/resources/videos/a-gentle-introduction-to-tidy-statistics-in-r/). We won't have much time to review the basics of R programming during the first session.
...
<ins>Tables</ins>
- Thomas Mock, [“gt - a (G)rammar of (T)ables”](https://themockup.blog/posts/2020-05-16-gt-a-grammar-of-tables/). Introduction to the gt package, a more flexible instrument to export tables in PNG, PDF, or HTML formats.
...
My name is Marc-Andrea Fiorina, and I am a public policy analyst. Over the past six years, I worked as an intern, research assistant, and analyst using R for impact evaluations and economic research programs with Development Impact (DIME) at the World Bank and at OpenResearch. I hold a Bachelor of Arts (Hons.) in Philosophy, Politics, and Economics from the University of Oxford (2017) and a Master of Arts in International Politics and Economics (Bologna 2018, DC 2019) from Johns Hopkins University SAIS.
